...
EVAL_STEPS = 20000               # numarul de pasi intr-o evalauare
...
RUNID = 'run_12'                  # numele sesiunii de tensorboard
...
def train():
    """antrenarea si evaluarea retelei"""
    my_replay_memory = ReplayMemory(size=MEMORY_SIZE, batch_size=BS)
    update_networks = TargetNetworkUpdater(MAIN_DQN_VARS, TARGET_DQN_VARS)
    
    explore_exploit_sched = ExplorationExploitationScheduler(MAIN_DQN, atari.env.action_space.n,  epsilon_initial=0.01, replay_memory_start_size=REPLAY_MEMORY_START_SIZE, max_frames=MAX_FRAMES)
...
#        update_networks(sess) # aici
        ...
        while frame_number < MAX_FRAMES:
            ...
            while epoch_frame < EVAL_FREQUENCY:
                ...
                # afisam rezultatele la fiecare 10 episoade
                if len(rewards) % 10 == 0:
                    # Scalari pentru tensorboard
