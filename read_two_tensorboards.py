...
def plot_tensorflow_log(path):
    ...
    event_acc_old = EventAccumulator('/home/valentinpuiu/projects/deep-q-network/results/breakout/events.out.tfevents.1619207732.pop-os')
    event_acc_new = EventAccumulator('/home/valentinpuiu/projects/deep-q-network/results/breakout/events.out.tfevents.1619300292.pop-os')
...
#    conv3 = event_acc.Histograms('mainDQN/conv3_1')
    ...
    x = np.arange(old_steps + new_steps)
    y = np.zeros([old_steps + new_steps, 1])
